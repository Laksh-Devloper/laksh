...
$(document).ready(() => {
    ...
    for (let i in links) {
        ...
        $('#marquee').append(`<a href="https://discord.gg/ZPA6yaE5sP" target="_BLANK">${link.name}</a>`);
    ...
    app.titleChanger(["It's Laksh", "It's Laksh", "It's Laksh", "It's Laksh", "It's Laksh", "It's Laksh", "It's Laksh", "It's Laksh"]);
    app.iconChanger(['assets/icons/krok/icon.png']);
});
